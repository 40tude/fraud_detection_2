...
k_Modelizer_URL = "http://127.0.0.1:8000/predict"
...
def read_infere_store(consumer, producer) -> None:
    ...
    while True:
        try:
            ...
            response = requests.post(k_Modelizer_URL, json=json_data)
...
#                 # Add a feature "fraud_confirmed", set it to Nan and write on topic_2
#                 write_transaction_to_topic_2(producer, current_transaction_df)
